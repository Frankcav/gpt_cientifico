...
> [!NOTE]  
> 1. La explicación detallada de cada archivo está en el [informe de autoanálisis](https://github.com/binary-husky/gpt_academic/wiki/GPT‐Academic项目自译解报告) `self_analysis.md`. Puedes regenerarlo siempre que quieras.  
...
--- | ---  
⭐ [Integración de nuevos modelos](https://github.com/binary-husky/gpt_academic/wiki/%E5%A6%82%E4%BD%95%E5%88%87%E6%8D%A2%E6%A8%A1%E5%9E%8B) | Compatibilidad con **Baidu Wenxin**, **Qwen**, **InternLM**, **Spark**, **LLaMA2**, **GLM4**, **DALL·E 3**, **DeepseekCoder**, etc.  
...
⭐ Entrada de voz en tiempo real | [Plugin de audio](https://github.com/binary-husky/gpt_academic/blob/master/docs/use_audio.md) que escucha asincrónicamente y responde con contexto.  
...
- Script **One‑click** en Windows desde [Releases](https://github.com/binary-husky/gpt_academic/releases).  
...
> - **2024.5.1**: Nueva función **Doc2x** para traducir artículos académicos en PDF. [Ver detalles](https://github.com/binary-husky/gpt_academic/wiki/Doc2x).  
